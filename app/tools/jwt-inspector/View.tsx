          ...
          <div className="grid gap-4 md:grid-cols-3">
            <section className="rounded-2xl border border-rose-500/30 bg-ink-900/40 p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <CopyButton value={JSON.stringify(parsed.jwt.header, null, 2)} />
              </div>
              <JsonView value={parsed.jwt.header} />
            </section>
            <section className="rounded-2xl border border-fuchsia-500/30 bg-ink-900/40 p-4">
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-xs font-semibold uppercase tracking-wider text-fuchsia-300">
                  Payload
                </h2>
                <CopyButton
                  value={
                    typeof parsed.jwt.payload === "string"
                      ? parsed.jwt.payload
                      : JSON.stringify(parsed.jwt.payload, null, 2)
                  }
                />
              </div>
            ...
            <section className="rounded-2xl border border-sky-500/30 bg-ink-900/40 p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                {parsed.jwt.segments.signatureB64 && (
                  <CopyButton value={parsed.jwt.segments.signatureB64} />
                )}
              </div>
